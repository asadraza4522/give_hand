...
import { getProductsCategories, getProductsUser, saveFCMtoken } from '../../utilies/api/apiCalls';
...
const SignUp = ({ navigation }) => {
    ...
    const Submit = async (type) => {
        let validate = Signup_validation({ fullName, userEmail, password, againPassword })
        ...
        <SafeAreaView style={Theme.container}>
            ...
            <Loader animating={loading} />
                <View style={[Theme.container, styles.center]}>
                    <ThemeRect style={styles.selfAlign} front={'white'} back={Color.ThemeColor} />
                    ...
                    <FormInput
                        ...
                        textInputContainerStyle={[Theme.InputView, firstFocus && { borderColor: Color.ThemeColor }]}
                    ...
                    <FormInput
                        ...
                        textInputContainerStyle={[Theme.InputView, secondFocus && { borderColor: Color.ThemeColor }]}
                        style={[Theme.TextInputStyle]}
                    ...
                    <FormInput
                        ...
                        textInputContainerStyle={[Theme.InputView, thirdFocus && { borderColor: Color.ThemeColor }]}
                        style={Theme.TextInputStyle}
                        containerStyle={Theme.TextInputContainer}
                        placeholderTextColor={Color.AuthInputsPlaceholder}
                    ...
                    <FormInput
                        ...
                        textInputContainerStyle={[Theme.InputView, fourFocus && { borderColor: Color.ThemeColor }]}
                        style={Theme.TextInputStyle}
                        containerStyle={Theme.TextInputContainer}
                        placeholderTextColor={Color.AuthInputsPlaceholder}
                        leftIcon={{ family: 'Feather', name: 'lock', color: Color.neutralGray, size: 18 }}
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', }}>
                        <Text style={[Theme.btnStyle, { color: Color.white, paddingHorizontal: 10, paddingVertical: 5 }]} onPress={() => Submit('seller')}>Sign Up as Seller</Text>
                        <Text style={[Theme.btnStyle, { color: Color.white, paddingHorizontal: 10, paddingVertical: 5 }]} onPress={() => Submit('user')}>Sign Up as User</Text>
                    </View>
                    <TwoTextFV onPress={() => { navigation.navigate('Login') }} style={{ textAlign: 'center', marginTop: '4%' }} first='Have a account?' second={'Sign In'} />
