...
import { getAdminBrandsApi, delAdminBrandsApi } from '../../../utilies/api/apiController';
...
const ViewBrand = ({ navigation, HideBackground, getData }) => {
    ...
    let Search = { "placeHolder": "Search Brands", onPress: HandleSearch.bind(this, 'press'), active: enableSearch, cancelFun: CancelSearch }
    ...
    return (
        <>
            {HideBackground !== undefined
                ...
                ?
                <SearchAndList searchData={searchData} setSearchData={setSearchData} search={Search} hideControls handleFunction={getData ? getData : handleOnPress} setEditFun={setEditFun} deleteListItem={deleteListItem} navigation={navigation} onRefresh={refreshing} refreshData={getRefreshData} loadMore={getBrandsList} data={allBrand} />
                :
                <View style={Theme.TabViewCreateInsideContainer}>
                    <Text style={Theme.CreateViewHeading}>Brands List</Text>
                    <SearchAndList searchData={searchData} setSearchData={setSearchData} search={Search} setEditFun={setEditFun} deleteListItem={deleteListItem} navigation={navigation} onRefresh={refreshing} refreshData={getRefreshData} loadMore={getBrandsList} data={allBrand} />
                </View>
