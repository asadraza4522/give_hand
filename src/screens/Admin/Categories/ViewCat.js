...
import { getAdminCategoriesApi, delAdminCategoriesApi } from '../../../utilies/api/apiController';
...
const ViewCat = ({ navigation, HideBackground, hideControls, getData }) => {
    ...
    let Search = { "placeHolder": "Search Categories", onPress: HandleSearch.bind(this,'press'), active: enableSearch, cancelFun: CancelSearch }
        ...
        <>
            {
                HideBackground !== undefined
                    ?
                    <SearchAndList searchData={searchData} setSearchData={setSearchData} search={Search} hideControls handleFunction={getData ? getData : handleOnPress} setEditFun={setEditFun} deleteListItem={deleteListItem} navigation={navigation} onRefresh={refreshing} refreshData={getRefreshData} loadMore={getCategoriesList} data={allCateg} />

                    :
                    <View style={Theme.TabViewCreateInsideContainer}>
                        <Text style={Theme.CreateViewHeading}>Categories List</Text>
                        <SearchAndList searchData={searchData} setSearchData={setSearchData} search={Search} setEditFun={setEditFun} deleteListItem={deleteListItem} navigation={navigation} onRefresh={refreshing} refreshData={getRefreshData} loadMore={getCategoriesList} data={allCateg} />
                    </View>
            }
        </>
