...
const EditUser = ({navigation, route}) => {
  ...
  const editUserProfile = async () => {
    try {
      let validate = Edit_Profile_Valid({
        fullName,
        gender,
        oldPassword,
        confirmPassword,
    ...
    <SafeAreaView style={Theme.container}>
      ...
      <ScrollView style={{marginBottom: 5}}>
        ...
        <FormInput
          ...
          onChangeText={data => {
            setErrortext(''), setPhone(data.trim());
          }}
          textInputContainerStyle={[Theme.InputView]}
          style={[Theme.TextInputStyle]}
          containerStyle={Theme.TextInputContainer}
        ...
        <FormInput
          ...
          placeholder="Gender"
          onPress={() => {
            setGenderList(GenderList.length > 0 ? [] : ['Male', 'Female']);
          }}
          ListOnPress={data => {
            setGender(data);
            setGenderList([]);
          ...
          value={gender}
          error={
            errortext === 'Please Select Gender' ? 'Please Select Gender' : null
          }
        />
        ...
        <View
          style={[
            Theme.DashedBorder,
            Platform.OS == 'ios' && {borderStyle: 'solid'},
          ]}
        />
        ...
        <FormInput
          ...
          onChangeText={data => {
            setErrortext(''), setOldPassword(data);
          }}
          textInputContainerStyle={[Theme.InputView]}
          style={[Theme.TextInputStyle]}
          containerStyle={Theme.TextInputContainer}
        ...
        <FormInput
          ...
          onChangeText={data => {
            setErrortext(''), setNewPassword(data);
          }}
          textInputContainerStyle={[Theme.InputView]}
          style={[Theme.TextInputStyle]}
          containerStyle={Theme.TextInputContainer}
          ...
          value={newPassword}
          error={
            errortext === 'New Password & Confirm Password Does Not Match'
        ...
        <FormInput
          ...
          onChangeText={data => {
            setErrortext(''), setConfirmPassword(data);
          }}
          textInputContainerStyle={[Theme.InputView]}
          style={[Theme.TextInputStyle]}
      ...
      <Btn
        ...
        containerStyle={{...Theme.btnStyle, marginBottom: 20}}
